...
export function MovieDetail({ movieId, onNavigate } ) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <div className="relative h-[400px] bg-gradient-to-t from-black to-transparent">
          ...
          <div className="flex gap-6 items-end">
            ...
            <div className="text-white pb-4">
              ...
              <div className="flex items-center gap-4 mb-4">
                <div className="flex items-center gap-1 bg-yellow-500 text-black px-3 py-1 rounded">
              ...
              <div className="flex gap-2 mb-4">
                {movie.genre.map((g) => (
                  <Badge key={g} variant="secondary" className="bg-white/20 text-white border-0">
                    {g}
                  </Badge>
                ))}
              </div>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-2xl font-bold">Reviews ({movie.reviewCount})</h2>
                  ...
                  <div>
                    ...
                    <div className="space-y-1">
                      {movie.cast.map((actor) => (
                        <p key={actor} className="font-semibold">{actor}</p>
                      ))}
                    </div>
                  </div>
                  <Separator />
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-bold">{movie.reviewCount}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
